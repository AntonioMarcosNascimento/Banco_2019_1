...
public class BancoTeste {
	...
	public static void main(String[] args) {
		...
		double totalSaldoPoupancas = fachada.recuperarSaldoTotalContas(TipoConta.POUPANCA);

		System.out.println("O saldo total Poupancas é: " + totalSaldoPoupancas);

		double totalSaldoContasCorrentes = fachada.recuperarSaldoTotalContas(TipoConta.CORRENTE);

		System.out.println("O saldo total C/C é: " + totalSaldoContasCorrentes);
